...
<h3 style="font-family: 'Maven Pro';">Desarrollos</h3>
</div>
<div class="input-field col s12 m6">
    <i class="material-icons prefix">search</i>
    <input id="search" name="search" type="text" >
    <label for="search">Buscar (Solamente por Nombre de desarrollo)</label>
</div>
...
<div id="modal-propiedad" class="modal">
    <div class="modal-content">
        ...
        <div class="row">
            <form class="col s12 pretty-form" id="form-propiedad" data-href="admin/insertar_desarrollo">
                <fieldset>
                ...
                <div class="row valign-wrapper">
                    ...
                    <div class="input-field col s6">
                        ...
                        <label for="nombre_propiedad">Nombre desarrollo *</label>
                    </div>
                    <div class="input-field col s6">
                        <select name="tipo">
                    ...
                    <div class="col s12 center-align" id="btn-insert">
                        <button class="btn waves-effect waves-light light-blue" type="submit" id="enviar-propiedad" href="admin/insertar_desarrollo" style="margin-top: 20px;">Enviar
...
<div id="modal-imagenes" class="modal">
    <div class="modal-content">
        <h3>Galería del desarrollo</h3>
        <div class="row">
            <form id="form-galeria">
                <input type="hidden" id="id_desarrollo" name="id_desarrollo" />
                ...
                <div class="col s4">
                    <button class="btn-large waves-effect waves-light light-green" type="submit" href="admin/insertar_desarrollo">Subir
                        <i class="material-icons right">send</i>
                    </button>
                </div>
            </form>
...
<script>
    ...
    $( document ).ready(function(){
        ...
        var opts = {
            ...
            onEnd: function(evt){
                ...
                if(posOld != posNew){
                    ...
                    $.ajax({
                        url: 'admin/actualizar_prioridad_desarrollo',
        ...
        var opts = {
            ...
            onEnd: function(evt){
                ...
                if(posOld != posNew){
                    ...
                    order = JSON.stringify(order);
                    $.ajax({
                        url: 'admin/actualizar_prioridad_imagen_desarrollo',
                        data: {posiciones: order},
                        type: 'POST',
                        cache: false,
                        success:function(data){
            ...
            onFilter: function (evt) {
                ...
                $.ajax({
                    url: 'admin/eliminar_foto_desarrollo',
                    type: 'POST',
        ...
        $('#form-galeria').ajaxForm({
            url: 'admin/subir_galeria_desarrollo',
            type: 'POST',
            dataType: 'json',
            beforeSend: function() {
            ...
            success:function(data){
                ...
                swal({type: icon, text: texto, title: title}).then( (result) => {
                    var idAuto = $('#form-galeria #id_desarrollo').val()
                    getGaleria(idAuto);
        ...
        $('#alta-propiedad').click(function(e){
            e.preventDefault();
            $('#form-propiedad').data('href', 'admin/insertar_desarrollo');
        ...
        $("#search").on('keyup', function (e) {
            if (e.keyCode == 13) {
                $.ajax({
                    url: 'admin/busqueda_desarrollos',
                    cache: false,
                    type: 'POST',
    ...
    function editarPropiedad(idPropiedad){
        $('#form-propiedad').data('href', 'admin/actualizar_desarrollo');
        clearForm($('#form-propiedad')[0]);
        $.ajax({
            url: 'admin/get_desarrollo',
            cache: false,
            type: 'POST',
            dataType: 'json',
            ...
            success: function(data){
                if(data.success == true){
                    ...
                    $('#preview').attr('src', 'imagenes_desarrollo/' + propiedad.id + '/' + propiedad.imagen_portada);
                    $('#preview').show();
    ...
    function cargarCatalogo(){
        $.ajax({
            url: 'admin/get_catalogo_desarrollos/1',
            cache: false,
            success:function(data){
    ...
    function subirGaleria(idAuto){
        ...
        $('#galeria').val('');
        clearForm('#form-galeria');
        $('#form-galeria #id_desarrollo').val(idAuto);
        getGaleria(idAuto);
    }

    function getGaleria(idAuto){
        $.ajax({
            url: 'admin/get_galeria_desarrollo',
            cache: false,
            type: 'POST',
            dataType: 'json',
            data: {id_desarrollo: idAuto},
            success: function(data){
                $('#list-galeria').html('');
    ...
    function eliminarPropiedad(idPropiedad){
        console.log();
        swal({
            title: '¿Está seguro que desea eliminar el desarrollo?',
            ...
            if (result.value) {
                $.ajax({
                    url: 'admin/eliminar_desarrollo',
                    cache: false,
                    type: 'POST',
                    dataType: 'json',
                    data: {id_desarrollo: idPropiedad},
                    success: function(data){
