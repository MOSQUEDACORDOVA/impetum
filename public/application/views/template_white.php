<html lang="es">
	...
	<body>
		<div id="header" class="hasScrolled">
			<div id="content-head">
				<a href="<?php echo base_url();?>inicio"><img src="<?php echo base_url();?>site-img/logo_head_black.svg" id="logo"></a>
				<span class="visible-xs menu-2" id="menu" style="font-family: 'Raleway';font-size: 11px;color:#FFF;position: absolute;right:60px;top:1px;cursor: pointer;"></span>
				<div class="hamburger hamburger--minus right-position abrir visible-xs">
					<div class="hamburger-box">
				      <div class="hamburger-inner ham2"></div>
				    </div>
				</div>
