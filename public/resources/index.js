...
$( document ).ready(function() {
    $("#mouseStrato").click(function(){
        $("html,body").animate({ scrollTop: $("#hola").offset().top}, 500,'swing');
    });
    ...
    $(window).scroll(function (event) {
        ...
        $('#navegacion').toggleClass('view',
         //add 'ok' class when div position match or exceeds else remove the 'ok' class.
          scroll >= $('#hola').offset().top
        );
        if($('header').hasClass('menu-is-open')){
            $('header').addClass('view');
            //$('header').css('background','rgb(28,28,28)');
        }
    });
    //trigger the scroll
