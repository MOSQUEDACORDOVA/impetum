...
<div class="contenedorPropiedades">
	<div class="formatoTitulosImpetum" style="padding-top:35px;padding-bottom: 55px;font-size: 16px;text-align: left;">
		<hr class="redRule" style="width: 40px;">&nbsp;&nbsp;&nbsp;&nbsp;Desarrollos
	...
	<div id="filtros-desktop" class="filtros hidden-xs">
		FILTRAR POR:&nbsp;&nbsp;&nbsp;&nbsp;<span id="todas" onclick="filtros('todas')">VER TODAS</span>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<span id="venta" onclick="filtros('venta')">EN VENTA</span>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<span id="renta" onclick="filtros('renta')">EN RENTA</span>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<span id="preventa" onclick="filtros('preventa')">PREVENTA</span>
		
		<div class="div-filtros" style="float: right;position: relative;top:-10px;">
			<select id="filtro-estado" class="form-control hidden-sm" style="width: 160px;display: inline;" onchange="filtro_select()">
...
<script>
	...
	$( document ).ready(function() {
		$('#todas').click();
		$.ajax({
			url:"desarrollos/show_propiedades",
			type:'POST',
	...
	$("#buscador").on('keyup', function (e) {
        if ($("#buscador").val() == '') {
            ...
            $.ajax({
                url: 'desarrollos/busqueda_desarrollos',
                cache: false,
                type: 'POST',
	...
	function filtros(filtro){
		...
		switch(filtro) {
		  ...
		  case 'venta':
		    // code block
		    $.ajax({
				url:"desarrollos/show_propiedades_filtro",
	...
	function filtro_select(){
		...
		$.ajax({
			url:"desarrollos/show_propiedades_filtros",
			type:'POST',
