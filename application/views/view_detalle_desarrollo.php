	...
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
			<div style="position: relative;">
				<img class="abrir-galeria" src="<?=base_url('imagenes_desarrollo/'.$id.'/'.$portada.'');?>" style="width: 100%;cursor: pointer;">
				<button class="btn video-360 hidden-xs abrir-galeria" style="color:rgb(217, 39, 65)!important;position: absolute;bottom: 5;right: 25;"><img src="<?=base_url('site-img/camera-back.svg');?>" width="22" style="position:relative;top:5px;">&nbsp;&nbsp;&nbsp;FOTOS</button>
			</div>
			<div class="visible-xs" style="width: 100%;height: 25px;"></div>
			<button class="btn solicitar-informes visible-xs" data-toggle="modal" data-target="#modalDesarrollo" data-titulo="<?=$nombre_propiedad;?>" data-id="<?=$id;?>">SOLICITAR INFORMES</button>
		...
		<div class="col-lg-4 col-md-4 col-sm-5 col-xs-12">
			<button class="btn solicitar-informes hidden-xs" data-toggle="modal" data-target="#modalDesarrollo" data-titulo="<?=$nombre_propiedad;?>" data-id="<?=$id;?>">SOLICITAR INFORMES</button>
			<div style="width: 100%;height: 20px;"></div>
...
<script>
	...
	$( document ).ready(function() {
		...
		$( ".abrir-galeria" ).click(function() {
		    ...
		    $.ajax({
				url:"<?php echo base_url().'desarrollos/get_propiedades'; ?>",
				type:'POST',
				data:{id:<?php echo $id;?>},
